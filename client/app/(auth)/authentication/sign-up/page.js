            ...
            {hasMounted &&
              <Form onSubmit={handleSubmit(onSubmitFunc)}>
                ...
                <Form.Group className="mb-3" controlId="username">
                  ...
                  <Form.Control type="text" name="username" placeholder="User Name" required="" {...register('username')} />
                </Form.Group>
                {/* Email */}
                <Form.Group className="mb-3" controlId="email">
                  <Form.Label>Email</Form.Label>
                  <Form.Control type="email" name="email" placeholder="Enter address here" required="" {...register('email')} />
                </Form.Group>

                {/* Password */}
                <Form.Group className="mb-3" controlId="password">
                  <Form.Label>Password</Form.Label>
                  <Form.Control type="password" name="password" placeholder="**************" required="" {...register('password')} />
                </Form.Group>
